...
public class TopAndBottomView {
    ...
    private static void topView(TreeNode node, int nodeValue, Map<Integer, String> map) {
    ...
    private static void bottomView(TreeNode node, int nodeValue, Map<Integer, String> map) {
        map.put(nodeValue, node.getValue());
        if(node.getLeft() != null){
