...
public class LeastCommonAncestor {
    ...
    private static String calcLeastCommonAncestor(TreeNode node1, TreeNode node2, TreeNode root) {
        String result = null;
    ...
    private static void findPath(TreeNode node, TreeNode curr, ArrayList<String> path) {
